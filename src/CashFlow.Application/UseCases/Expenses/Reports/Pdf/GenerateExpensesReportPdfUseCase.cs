...
public class GenerateExpensesReportPdfUseCase : IGenerateExpensesReportPdfUseCase
{
    ...
    private readonly string CURRENCY_SYMBOL = CultureInfo.CurrentCulture.NumberFormat.CurrencySymbol;
    ...
    private Document CreateDocument(string userName, DateOnly month)
    {
    ...
    private void CreateHeaderWithProfilePhotoAndName(string userName, Section page)
    {
        ...
        var directoryName = Path.GetDirectoryName(assemply.Location);
    ...
    private void CreateTotalSpentSection(Section page, DateOnly month, decimal totalExpenses)
    {
        ...
        paragraph.AddFormattedText($"{totalExpenses.ToString("N2", CultureInfo.CurrentCulture)} {CURRENCY_SYMBOL}", new Font { Name = FontHelper.WORKSANS_BLACK, Size = 50 });
    }
    ...
    {
        cell.AddParagraph($"-{amount.ToString("N2", CultureInfo.CurrentCulture)} {CURRENCY_SYMBOL}");
