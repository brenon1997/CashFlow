...
public class ChangePasswordUseCaseTest
{
    ...
    public async Task Error_NewPassword_Empty()
    {
        ...
        result.GetErrors().ShouldHaveSingleItem().ShouldBe(ResourceErrorMessages.INVALID_PASSWORD);
    }
    ...
    public async Task Error_CurrentPassword_Different()
    {
        ...
        result.GetErrors().ShouldHaveSingleItem().ShouldBe(ResourceErrorMessages.PASSWORD_DIFFERENT_CURRENT_PASSWORD);
    }
